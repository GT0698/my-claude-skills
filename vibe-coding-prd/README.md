...
本 skill 是合集仓库 [`my-claude-skills`](https://github.com/GT0698/my-claude-skills) 下的子目录，先克隆再把这个子目录拷进 skills 目录即可。

### 装到全局（所有项目可用）

```bash
git clone https://github.com/GT0698/my-claude-skills.git /tmp/my-claude-skills
cp -r /tmp/my-claude-skills/vibe-coding-prd ~/.claude/skills/
```
